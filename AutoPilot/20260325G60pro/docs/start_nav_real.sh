...
echo "  /camera_front/depth/scan       <- 2D 激光扫描（车头，近场避障）"
echo "  /camera_rear/depth/scan        <- 2D 激光扫描（车尾，近场避障）"
echo "  /camera_left/depth/scan        <- 2D 激光扫描（左侧，近场避障）"
echo "  /camera_right/depth/scan       <- 2D 激光扫描（右侧，近场避障）"
echo ""
